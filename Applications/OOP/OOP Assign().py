'''
Write a function assign() that takes a list of Student objects,
a student full name, a password, and a project as parameters.

This function should search the list of students for students
whose name and password match the supplied information.

When a match is found, the function checks the student's
current list of projects for the supplied project.
If the project does not already exist in the list,
the function adds the project to the list.
Remember to use only methods for the Student class
