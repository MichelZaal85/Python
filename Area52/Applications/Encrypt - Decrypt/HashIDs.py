...
def CRC16():
    hs = '4607'
    if len(hash) == len(hs) and not hash.isalpha() and hash.isalnum():
        jerar.append("101020")


def CRC16CCITT():
    hs = '3d08'
    if len(hash) == len(hs) and not hash.isdigit()\
       and not hash.isalpha() and hash.isalnum():
        jerar.append("101040")
...
def GHash323():
    hs = '80000000'
    if len(hash) == len(hs) and hash.isdigit()\
       and not hash.isalpha() and hash.isalnum():
        jerar.append("103040")
...
def DESUnix():
    hs = 'ZiY8YtDKXJwYQ'
    if len(hash) == len(hs) and not hash.isdigit() and not hash.isalpha():
        jerar.append("104020")
...
def LineageIIC4():
    ...
    if len(hash) == len(hs) and not hash.isdigit()\
       and not hash.isalpha() and hash.isalnum() and hash[0:2].find('0x') == 0:
        jerar.append("107080")
...
def MD5phpBB3():
    ...
    if len(hash) == len(hs) and not hash.isdigit()\
       and not hash.isalpha() and not hash.isalnum()\
...
def MD5APR():
    ...
    if len(hash) == len(hs) and not hash.isdigit()\
       and not hash.isalpha() and hash[0:4].find('$apr') == 0:
        jerar.append("108020")
...
def SAM():
    ...
    if len(hash) == len(hs) and not hash.isdigit()\
       and not hash.isalpha() and not hash.isalnum()\
       and not hash.islower() and not hash[32:33].find(':'):
        jerar.append("116040")
